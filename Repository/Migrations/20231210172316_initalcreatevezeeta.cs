...
{
    /// <inheritdoc />
    public partial class initalcreatevezeeta : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Completetdrequests = table.Column<int>(type: "int", nullable: false),
                    AdminId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Appointments", x => x.AppointementId);
                    table.ForeignKey(
                        name: "FK_Appointments_DiscountCodes_DiscountId",
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "AdminId", "AdminEmail", "AdminName", "AdminPassword", "DateOfBirth", "Phone" },
                values: new object[] { 1, "Ali111@gmail.com", "Ali", "hgh154", new DateTime(2000, 5, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "1257963255" });
